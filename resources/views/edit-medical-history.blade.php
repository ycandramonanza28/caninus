    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pasien/ Data Riwayat Medis/ Detail Riwayat
                    Medis/</span> Ubah Riwayat Medis</h4>
            @if (session('error'))
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">Ubah Riwayat Medis</h5>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="private_doctor"
                                            ...
                                            value="{{ old('private_doctor') ? old('private_doctor') : $medicalHistories['private_doctor'] }}"/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="serious_illness"
                                            ...
                                            value="{{ old('serious_illness') ? old('serious_illness') : $medicalHistories['serious_illness'] }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="under_doctor_care"
                                            ...
                                            value="{{ old('under_doctor_care') ? old('under_doctor_care') : $medicalHistories['under_doctor_care'] }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="in_drug_consumption"
                                            ...
                                            value="{{ old('in_drug_consumption') ? old('in_drug_consumption') : $medicalHistories['in_drug_consumption'] }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="blood_transfusion"
                                            ...
                                            value="{{ old('blood_transfusion') ? old('blood_transfusion') : $medicalHistories['blood_transfusion'] }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="smoker"
                                            ...
                                            placeholder="Perokok ..."  value="{{ old('smoker') ? old('smoker') : $medicalHistories['smoker'] }}" />
                                        @error('smoker')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    id="heart_defects" value="1"  {{ $medicalHistories->heart_defects ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="blood_pressure"
                                                        id="blood_pressure" value="1" {{ $medicalHistories->blood_pressure ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="diabetes"
                                                        id="diabetes" value="1" {{ $medicalHistories->diabetes ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="1" {{ $medicalHistories->hepatitis_jaundice_liver ? 'checked' : '' }}>
                                    ...
                                    <div class="info-item">
                                        <div class="row">
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="ashma"
                                                        id="ashma" value="1" {{ $medicalHistories->ashma ? 'checked' : '' }}> <label class="form-check-label"
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="therapy_cancer"
                                                        id="therapy_cancer" value="1"  {{ $medicalHistories->therapy_cancer ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="blood_disorders" id="blood_disorders" value="1" {{ $medicalHistories->blood_disorders ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="hiv_aids"
                                                        id="hiv_aids" value="1" {{ $medicalHistories->hiv_aids ? 'checked' : '' }}>
                                    ...
                                    <div class="info-item">
                                        <div class="row">
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="digestive_tract" id="digestive_tract" value="1" {{ $medicalHistories->hiv_aids ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="epilepsy"
                                                        id="epilepsy" value="1" {{ $medicalHistories->epilepsy ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="pregnant"
                                                        id="pregnant" value="1"  {{ $medicalHistories->pregnant ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        value="1" {{ $medicalHistories->drink_blood_thinners ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        ...
                                                        id="taking_medicine_osteoporosis" value="1" {{ $medicalHistories->taking_medicine_osteoporosis ? 'checked' : '' }}>
                                                    <label class="form-check-label"
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="allergy"
                                                        id="allergy" value="1" {{ $medicalHistories->allergy ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12 col-md-3 col-lg-3">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="other"
                                                        value="1" {{ $medicalHistories->other ? 'checked' : '' }}>
                                ...
                                <div class="row mb-3" id="other-input" style="display: none;">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="other" class="form-control @error('other') is-invalid @enderror" 
                                               id="other-text" placeholder="Lainnya ..." value="{{  $medicalHistories->other }}" />
                                        @error('other')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
