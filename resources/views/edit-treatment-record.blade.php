...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pasien/ Data Catatan Treatment/ Detail Catatan Treatment/</span> Ubah Catatan Treatment</h4>
            @if (session('error'))
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">Ubah Catatan Treatment</h5>
                            <small class="text-muted float-end">{{ $treatmentRecord->name }}</small>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('treatment.update', $treatmentNote->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="tooth"
                                            ...
                                            value="{{ old('tooth') ? old('tooth') : $treatmentNote['tooth'] }}"  />
                                        @error('tooth')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="diagnosa"
                                            ...
                                            value="{{ old('diagnosa') ? old('diagnosa') : $treatmentNote['diagnosa'] }}"  />
                                        @error('diagnosa')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="treatment_note"
                                            ...
                                            id="treatment_note" placeholder="Treatment Note ..." />{{ old('treatment_note') ? old('treatment_note') : $treatmentNote['treatment_note'] }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea type="text" name="note"
                                            ...
                                            id="note" placeholder="Treatment Note ..."/>{{ old('note') ? old('note') : $treatmentNote['note'] }}</textarea>
                                        @error('note')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
