...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pasien/ Data Pasien/ </span> Edit Pasien</h4>
            @if (session('error'))
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="parents_name"
                                            ...
                                            value="{{ old('parents_name') ? old('parents_name') : $patient['parents_name'] }}" />
                                        @error('parents_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="house_phone"
                                            ...
                                            value="{{ old('house_phone') ? old('house_phone') : $patient['house_phone'] }}" />
                                        @error('house_phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="office_phone"
                                            ...
                                            value="{{ old('office_phone') ? old('office_phone') : $patient['office_phone'] }}" />
                                        @error('office_phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="mobile_phone"
                                            ...
                                            value="{{ old('mobile_phone') ? old('mobile_phone') : $patient['mobile_phone'] }}" />
                                        @error('mobile_phone')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="emergency_number"
                                            ...
                                            value="{{ old('emergency_number') ? old('emergency_number') : $patient['emergency_number'] }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" name="date_of_birth"
                                            ...
                                            value="{{ old('date_of_birth') ? old('date_of_birth') : $patient['date_of_birth'] }}" />
                                        @error('date_of_birth')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="place_of_birth"
                                            ...
                                            value="{{ old('place_of_birth') ? old('place_of_birth') : $patient['place_of_birth'] }}" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="the_referring"
                                            ...
                                            value="{{ old('the_referring') ? old('the_referring') : $patient['the_referring'] }}" />
                                        @error('the_referring')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
