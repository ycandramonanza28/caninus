...
@section('content')
    ...
    <div class="wrapper">
                    ...
                    <div class="carousel-caption position-static" style="z-index: 1;">
                        ...
                        <div class="d-flex justify-content-center gap-5 flex-wrap">
                            <div class="card" style="width: 18rem;">
                                <img src="{{ asset('img/doctor.png') }}" class="card-img-top img-fluid"
                                    alt="Dentist Image" style="object-fit: contain; height: 250px;">
                            ...
                            <div class="card" style="width: 18rem;">
                                <img src="{{ asset('img/doctor1.png') }}" class="card-img-top img-fluid"
                                    alt="Dentist Image" style="object-fit: contain; height: 250px;">
                                <div class="card-body text-center">
        ...
        <div id="carouselExampleCaptionsMobile" class="carousel slide mod d-block d-md-none" data-bs-ride="carousel">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptionsMobile"
                data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptionsMobile"
                data-bs-slide="next">
                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
            </button>
