...
<div class="wrapper">
    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner">
            ...
            $banner = $locale === 'en' ? 'img/banner-caninus-1-en.jpg' :
            ($locale === 'zh' ? 'img/banner-caninus-1-zh.jpg' : 'img/banner-caninus-1-id.jpg');

            $banner2 = $locale === 'en' ? 'img/banner-caninus-2-en.jpg' :
            ($locale === 'zh' ? 'img/banner-caninus-2-zh.jpg' : 'img/banner-caninus-2-id.jpg');
