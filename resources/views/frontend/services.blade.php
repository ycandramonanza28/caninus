...
<div class="wrapper">
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-6 d-flex d-md-flex justify-content-md-end d-lg-flex justify-content-lg-end position-relative">
            ...
            <div class="ol-12 col-md-6 col-lg-6 d-flex d-md-flex justify-content-md-start d-lg-flex justify-content-lg-start position-relative">
