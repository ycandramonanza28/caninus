...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pasien/</span> Data Riwayat Medis</h4>
            @if (session('success'))
                        ...
                        <table class="table table-bordered p">
                            ...
                            <tbody>
                                @foreach ($medicalHistory as $history)
                                    <tr>
                                        <td>
                                            <span class="fab fa-angular fa-lg text-dark me-3">{{ $history->id }}</span>
                                        </td>
                                        <td>{{ $history->name }}</td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"  href="{{ route('medical.history.show', $history) }}">
